    ...
    <div class="box-form" id="signup-view">
        <div class="left">
            <div class="overlay">
                ...
                <p>I am already a member <strong><a href="<?php echo base_url('/sign_in'); ?>" style="color: #fafafa; "> Log In </a></strong></p>
            </div>
        </div>
        <div class="right">
            <div class="inputs">
                ...
                if (user.isValid()) {
                    user.save({}, {
                        ...
                        error: function(model, response) {
                            ...
                            alert('Given username is already taken. Please provide a different username.');
